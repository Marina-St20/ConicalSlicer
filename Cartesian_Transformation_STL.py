...
def transformation_STL_file(path, output_dir, cone_type, nb_iterations, cone_angle_deg):
    ...
    file_name = f"Safety_Test_Polar_{name}_{cone_angle_deg}deg_transformed{ext}"
...
file_path = r"C:\Users\canca\Documents\Conical Slicer Repo\ConicalSlicer\ISO 2.5 Benchy.stl"
