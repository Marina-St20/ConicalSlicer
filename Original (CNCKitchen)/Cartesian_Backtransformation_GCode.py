...
file_path = r"C:\Professional\3D4E\5AxisPrinter\ConicalSlicing\SlicedTransformedGcode\ASTM_Dogbone_outward_10deg_transformed.gcode"  # or .ufp
dir_backtransformed = r"C:\Professional\3D4E\5AxisPrinter\ConicalSlicing\DeformedGcode"

transformation_type = 'outward'    # must match Transformation_STL.py
