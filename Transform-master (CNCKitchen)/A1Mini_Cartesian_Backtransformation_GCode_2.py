...
FIXED_HEADER_PATH = r"C:\Professional\3D4E\5AxisPrinter\ConicalSlicing\HEADERBLOCKSTART.txt"
...
def backtransform_file(path, output_dir, cone_type, cone_angle_deg, maximal_length,
                       ...
                       bed_center_x=None, bed_center_y=None, fixed_e=0.03):
    """
    Full pipeline:
...
file_path           = r"C:\Professional\3D4E\5AxisPrinter\ConicalSlicing\SlicedTransformedGcode\ASTM_Dogbone_outward_5deg_transformed.gcode"
...
cone_angle_degrees  = 5.0         # must match Cartesian_Transformation_STL.py exactly
